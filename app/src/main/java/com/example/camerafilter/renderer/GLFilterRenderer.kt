package com.example.camerafilter.renderer

import android.opengl.GLES20
import android.util.Log
import com.example.camerafilter.gl_utils.ShaderUtils
...
class GLFilterRenderer {
    ...
    private val TAG = "GLFilterRenderer"
...
void main() {
    ...
    highp float colorR = (color.r + color.g + color.b) / 3.0;    gl_FragColor = vec4(colorR, colorR, colorR, color.a);
}"""
...
void main() {
  ...
  gl_Position = aPosition;
        ...
        Log.i(TAG, "initShader: $programId , $aPositionHandle , $sTextureSamplerHandle")
